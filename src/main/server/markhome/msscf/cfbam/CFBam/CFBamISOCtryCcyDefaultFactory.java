...
import server.markhome.msscf.cfint.CFInt.*;
	...
	/*
	 *	CFBamISOCtryCcyFactory implementation for ISOCtryCcy
	 */
public class CFBamISOCtryCcyDefaultFactory
	extends CFSecISOCtryCcyDefaultFactory
	implements ICFBamISOCtryCcyFactory
{
	public CFBamISOCtryCcyDefaultFactory() {
		super();
	}
