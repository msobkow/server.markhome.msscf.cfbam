...
public class CFBamISOCtryTableObj
	implements ICFBamISOCtryTableObj
{
	...
	public CFBamISOCtryTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecISOCtryObj newInstance() {
		ICFSecISOCtryObj inst = new CFBamISOCtryObj( schema );
		return( inst );
	}
	...
	public ICFSecISOCtryEditObj newEditInstance( ICFSecISOCtryObj orig ) {
		ICFSecISOCtryEditObj edit = new CFBamISOCtryEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByISOCodeIdx != null ) {
				CFSecISOCtryByISOCodeIdxKey keyISOCodeIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newISOCodeIdxKey();
			...
			if( indexByNameIdx != null ) {
				CFSecISOCtryByNameIdxKey keyNameIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newNameIdxKey();
	...
	public ICFSecISOCtryObj createISOCtry( ICFSecISOCtryObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().createISOCtry(
	...
	public ICFSecISOCtryObj readISOCtry( CFSecISOCtryPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecISOCtryBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredISOCtryId() );
			if( readBuff != null ) {
				obj = schema.getISOCtryTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newPKey() );
	...
	{
		final String S_ProcName = "CFBamISOCtryTableObj.reallyDeepDisposeISOCtry() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecISOCtryByISOCodeIdxKey keyISOCodeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newISOCodeIdxKey();
		keyISOCodeIdx.setRequiredISOCode( existing.getRequiredISOCode() );

		CFSecISOCtryByNameIdxKey keyNameIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newNameIdxKey();
	...
	public ICFSecISOCtryObj lockISOCtry( CFSecISOCtryPKey pkey ) {
		...
		CFSecISOCtryBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getISOCtryTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newPKey() );
	...
	public List<ICFSecISOCtryObj> readAllISOCtry( boolean forceRead ) {
		...
		if( ( allISOCtry == null ) || forceRead ) {
			...
			allISOCtry = map;
			CFSecISOCtryBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().readAllDerived( schema.getAuthorization() );
	...
	{
		CFSecISOCtryPKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newPKey();
	...
	public ICFSecISOCtryObj readISOCtryByISOCodeIdx( String ISOCode, boolean forceRead )
	{
		...
		CFSecISOCtryByISOCodeIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newISOCodeIdxKey();
		...
		if( ( ! forceRead ) && indexByISOCodeIdx.containsKey( key ) ) {
			...
			CFSecISOCtryBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().readDerivedByISOCodeIdx( schema.getAuthorization(),
				ISOCode );
			if( buff != null ) {
				obj = schema.getISOCtryTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newPKey() );
	...
	public ICFSecISOCtryObj readISOCtryByNameIdx( String Name, boolean forceRead )
	{
		...
		CFSecISOCtryByNameIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newNameIdxKey();
		...
		if( ( ! forceRead ) && indexByNameIdx.containsKey( key ) ) {
			...
			CFSecISOCtryBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().readDerivedByNameIdx( schema.getAuthorization(),
				Name );
			if( buff != null ) {
				obj = schema.getISOCtryTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOCtry().newPKey() );
	...
	public ICFSecISOCtryObj updateISOCtry( ICFSecISOCtryObj Obj ) {
		ICFSecISOCtryObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().updateISOCtry( schema.getAuthorization(),
			Obj.getISOCtryBuff() );
		obj = (ICFSecISOCtryObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteISOCtry( ICFSecISOCtryObj Obj ) {
		ICFSecISOCtryObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().deleteISOCtry( schema.getAuthorization(),
			obj.getISOCtryBuff() );
		Obj.forget();
	}
	...
	public void deleteISOCtryByISOCodeIdx( String ISOCode )
	{
		...
		if( indexByISOCodeIdx.containsKey( key ) ) {
			obj = indexByISOCodeIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().deleteISOCtryByISOCodeIdx( schema.getAuthorization(),
				ISOCode );
			obj.forget();
		}
		else {
	...
	public void deleteISOCtryByNameIdx( String Name )
	{
		...
		if( indexByNameIdx.containsKey( key ) ) {
			obj = indexByNameIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableISOCtry().deleteISOCtryByNameIdx( schema.getAuthorization(),
				Name );
			obj.forget();
		}
		else {
