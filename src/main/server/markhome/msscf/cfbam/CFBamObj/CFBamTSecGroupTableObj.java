	...
	implements ICFBamTSecGroupTableObj
{
	...
	public CFBamTSecGroupTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecTSecGroupObj newInstance() {
		ICFSecTSecGroupObj inst = new CFBamTSecGroupObj( schema );
		return( inst );
	}
	...
	public ICFSecTSecGroupEditObj newEditInstance( ICFSecTSecGroupObj orig ) {
		ICFSecTSecGroupEditObj edit = new CFBamTSecGroupEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				CFSecTSecGroupByTenantIdxKey keyTenantIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newTenantIdxKey();
			...
			if( indexByTenantVisIdx != null ) {
				CFSecTSecGroupByTenantVisIdxKey keyTenantVisIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newTenantVisIdxKey();
			...
			if( indexByUNameIdx != null ) {
				CFSecTSecGroupByUNameIdxKey keyUNameIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newUNameIdxKey();
	...
	public ICFSecTSecGroupObj createTSecGroup( ICFSecTSecGroupObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().createTSecGroup(
	...
	public ICFSecTSecGroupObj readTSecGroup( CFSecTSecGroupPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecTSecGroupBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredTenantId(),
				pkey.getRequiredTSecGroupId() );
			if( readBuff != null ) {
				obj = schema.getTSecGroupTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newPKey() );
	...
	{
		final String S_ProcName = "CFBamTSecGroupTableObj.reallyDeepDisposeTSecGroup() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecTSecGroupByTenantIdxKey keyTenantIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newTenantIdxKey();
		keyTenantIdx.setRequiredTenantId( existing.getRequiredTenantId() );

		CFSecTSecGroupByTenantVisIdxKey keyTenantVisIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newTenantVisIdxKey();
		...
		CFSecTSecGroupByUNameIdxKey keyUNameIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newUNameIdxKey();
	...
	public ICFSecTSecGroupObj lockTSecGroup( CFSecTSecGroupPKey pkey ) {
		...
		CFSecTSecGroupBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getTSecGroupTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newPKey() );
	...
	public List<ICFSecTSecGroupObj> readAllTSecGroup( boolean forceRead ) {
		...
		if( ( allTSecGroup == null ) || forceRead ) {
			...
			allTSecGroup = map;
			CFSecTSecGroupBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().readAllDerived( schema.getAuthorization() );
	...
	{
		CFSecTSecGroupPKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecTSecGroupByTenantIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newTenantIdxKey();
		...
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			...
			ICFSecTSecGroupObj obj;
			CFSecTSecGroupBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().readDerivedByTenantIdx( schema.getAuthorization(),
				TenantId );
			CFSecTSecGroupBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		CFSecTSecGroupByTenantVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newTenantVisIdxKey();
		key.setRequiredTenantId( TenantId );
		...
		if( ( ! forceRead ) && indexByTenantVisIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecTSecGroupPKey, ICFSecTSecGroupObj>();
			ICFSecTSecGroupObj obj;
			CFSecTSecGroupBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().readDerivedByTenantVisIdx( schema.getAuthorization(),
				TenantId,
				IsVisible );
			CFSecTSecGroupBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		String Name, boolean forceRead )
	{
		...
		CFSecTSecGroupByUNameIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGroup().newUNameIdxKey();
		key.setRequiredTenantId( TenantId );
		...
		if( ( ! forceRead ) && indexByUNameIdx.containsKey( key ) ) {
			...
			CFSecTSecGroupBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().readDerivedByUNameIdx( schema.getAuthorization(),
				TenantId,
				Name );
			if( buff != null ) {
				obj = schema.getTSecGroupTableObj().newInstance();
	...
	public ICFSecTSecGroupObj updateTSecGroup( ICFSecTSecGroupObj Obj ) {
		ICFSecTSecGroupObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().updateTSecGroup( schema.getAuthorization(),
	...
	public void deleteTSecGroup( ICFSecTSecGroupObj Obj ) {
		ICFSecTSecGroupObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().deleteTSecGroup( schema.getAuthorization(),
			obj.getTSecGroupBuff() );
		Obj.forget();
	}
	...
	public void deleteTSecGroupByTenantIdx( long TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().deleteTSecGroupByTenantIdx( schema.getAuthorization(),
				TenantId );
		...
		boolean IsVisible )
	{
		...
		if( indexByTenantVisIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().deleteTSecGroupByTenantVisIdx( schema.getAuthorization(),
				TenantId,
				IsVisible );
			Iterator<ICFSecTSecGroupObj> iter = dict.values().iterator();
			ICFSecTSecGroupObj obj;
		...
		String Name )
	{
		...
		if( indexByUNameIdx.containsKey( key ) ) {
			obj = indexByUNameIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGroup().deleteTSecGroupByUNameIdx( schema.getAuthorization(),
				TenantId,
				Name );
			obj.forget();
		}
