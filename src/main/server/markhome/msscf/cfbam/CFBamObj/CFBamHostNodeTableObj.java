	...
	implements ICFBamHostNodeTableObj
{
	...
	public CFBamHostNodeTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecHostNodeObj newInstance() {
		ICFSecHostNodeObj inst = new CFBamHostNodeObj( schema );
		return( inst );
	}
	...
	public ICFSecHostNodeEditObj newEditInstance( ICFSecHostNodeObj orig ) {
		ICFSecHostNodeEditObj edit = new CFBamHostNodeEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				CFSecHostNodeByClusterIdxKey keyClusterIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newClusterIdxKey();
			...
			if( indexByUDescrIdx != null ) {
				CFSecHostNodeByUDescrIdxKey keyUDescrIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newUDescrIdxKey();
			...
			if( indexByHostNameIdx != null ) {
				CFSecHostNodeByHostNameIdxKey keyHostNameIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newHostNameIdxKey();
	...
	public ICFSecHostNodeObj createHostNode( ICFSecHostNodeObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableHostNode().createHostNode(
	...
	public ICFSecHostNodeObj readHostNode( CFSecHostNodePKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecHostNodeBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredClusterId(),
				pkey.getRequiredHostNodeId() );
			if( readBuff != null ) {
				obj = schema.getHostNodeTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newPKey() );
	...
	{
		final String S_ProcName = "CFBamHostNodeTableObj.reallyDeepDisposeHostNode() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecHostNodeByClusterIdxKey keyClusterIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecHostNodeByUDescrIdxKey keyUDescrIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newUDescrIdxKey();
		keyUDescrIdx.setRequiredClusterId( existing.getRequiredClusterId() );
		keyUDescrIdx.setRequiredDescription( existing.getRequiredDescription() );

		CFSecHostNodeByHostNameIdxKey keyHostNameIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newHostNameIdxKey();
	...
	public ICFSecHostNodeObj lockHostNode( CFSecHostNodePKey pkey ) {
		...
		CFSecHostNodeBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getHostNodeTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newPKey() );
	...
	public List<ICFSecHostNodeObj> readAllHostNode( boolean forceRead ) {
		...
		if( ( allHostNode == null ) || forceRead ) {
			...
			allHostNode = map;
			CFSecHostNodeBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().readAllDerived( schema.getAuthorization() );
		...
		Long priorHostNodeId )
	{
		...
		Map<CFSecHostNodePKey, ICFSecHostNodeObj> map = new HashMap<CFSecHostNodePKey,ICFSecHostNodeObj>();
		CFSecHostNodeBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().pageAllBuff( schema.getAuthorization(),
			priorClusterId,
			priorHostNodeId );
		CFSecHostNodeBuff buff;
		ICFSecHostNodeObj obj;
	...
	{
		CFSecHostNodePKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecHostNodeByClusterIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newClusterIdxKey();
		...
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			...
			ICFSecHostNodeObj obj;
			CFSecHostNodeBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().readDerivedByClusterIdx( schema.getAuthorization(),
				ClusterId );
			CFSecHostNodeBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		String Description, boolean forceRead )
	{
		...
		CFSecHostNodeByUDescrIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newUDescrIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		if( ( ! forceRead ) && indexByUDescrIdx.containsKey( key ) ) {
			...
			CFSecHostNodeBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().readDerivedByUDescrIdx( schema.getAuthorization(),
				ClusterId,
				Description );
			if( buff != null ) {
				obj = schema.getHostNodeTableObj().newInstance();
		...
		String HostName, boolean forceRead )
	{
		...
		CFSecHostNodeByHostNameIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryHostNode().newHostNameIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		if( ( ! forceRead ) && indexByHostNameIdx.containsKey( key ) ) {
			...
			CFSecHostNodeBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().readDerivedByHostNameIdx( schema.getAuthorization(),
				ClusterId,
				HostName );
			if( buff != null ) {
				obj = schema.getHostNodeTableObj().newInstance();
		...
		Long priorHostNodeId )
	{
		...
		ICFSecHostNodeObj obj;
		CFSecHostNodeBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableHostNode().pageBuffByClusterIdx( schema.getAuthorization(),
				ClusterId,
			priorClusterId,
			priorHostNodeId );
		CFSecHostNodeBuff buff;
	...
	public ICFSecHostNodeObj updateHostNode( ICFSecHostNodeObj Obj ) {
		ICFSecHostNodeObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableHostNode().updateHostNode( schema.getAuthorization(),
			Obj.getHostNodeBuff() );
		obj = (ICFSecHostNodeObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteHostNode( ICFSecHostNodeObj Obj ) {
		ICFSecHostNodeObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableHostNode().deleteHostNode( schema.getAuthorization(),
			obj.getHostNodeBuff() );
		Obj.forget();
	}
	...
	public void deleteHostNodeByClusterIdx( long ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableHostNode().deleteHostNodeByClusterIdx( schema.getAuthorization(),
				ClusterId );
		...
		String Description )
	{
		...
		if( indexByUDescrIdx.containsKey( key ) ) {
			obj = indexByUDescrIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableHostNode().deleteHostNodeByUDescrIdx( schema.getAuthorization(),
				ClusterId,
				Description );
			obj.forget();
		}
		...
		String HostName )
	{
		...
		if( indexByHostNameIdx.containsKey( key ) ) {
			obj = indexByHostNameIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableHostNode().deleteHostNodeByHostNameIdx( schema.getAuthorization(),
				ClusterId,
				HostName );
			obj.forget();
		}
