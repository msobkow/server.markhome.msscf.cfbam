	...
	implements ICFBamSecGroupTableObj
{
	...
	public CFBamSecGroupTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecSecGroupObj newInstance() {
		ICFSecSecGroupObj inst = new CFBamSecGroupObj( schema );
		return( inst );
	}
	...
	public ICFSecSecGroupEditObj newEditInstance( ICFSecSecGroupObj orig ) {
		ICFSecSecGroupEditObj edit = new CFBamSecGroupEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				CFSecSecGroupByClusterIdxKey keyClusterIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newClusterIdxKey();
			...
			if( indexByClusterVisIdx != null ) {
				CFSecSecGroupByClusterVisIdxKey keyClusterVisIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newClusterVisIdxKey();
			...
			if( indexByUNameIdx != null ) {
				CFSecSecGroupByUNameIdxKey keyUNameIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newUNameIdxKey();
	...
	public ICFSecSecGroupObj createSecGroup( ICFSecSecGroupObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().createSecGroup(
	...
	public ICFSecSecGroupObj readSecGroup( CFSecSecGroupPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecSecGroupBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredClusterId(),
				pkey.getRequiredSecGroupId() );
			if( readBuff != null ) {
				obj = schema.getSecGroupTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newPKey() );
	...
	{
		final String S_ProcName = "CFBamSecGroupTableObj.reallyDeepDisposeSecGroup() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecSecGroupByClusterIdxKey keyClusterIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecSecGroupByClusterVisIdxKey keyClusterVisIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newClusterVisIdxKey();
		...
		CFSecSecGroupByUNameIdxKey keyUNameIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newUNameIdxKey();
	...
	public ICFSecSecGroupObj lockSecGroup( CFSecSecGroupPKey pkey ) {
		...
		CFSecSecGroupBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getSecGroupTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newPKey() );
	...
	public List<ICFSecSecGroupObj> readAllSecGroup( boolean forceRead ) {
		...
		if( ( allSecGroup == null ) || forceRead ) {
			...
			allSecGroup = map;
			CFSecSecGroupBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().readAllDerived( schema.getAuthorization() );
	...
	{
		CFSecSecGroupPKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecSecGroupByClusterIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newClusterIdxKey();
		...
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			...
			ICFSecSecGroupObj obj;
			CFSecSecGroupBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().readDerivedByClusterIdx( schema.getAuthorization(),
				ClusterId );
			CFSecSecGroupBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		CFSecSecGroupByClusterVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newClusterVisIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		if( ( ! forceRead ) && indexByClusterVisIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecGroupPKey, ICFSecSecGroupObj>();
			ICFSecSecGroupObj obj;
			CFSecSecGroupBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().readDerivedByClusterVisIdx( schema.getAuthorization(),
				ClusterId,
				IsVisible );
			CFSecSecGroupBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		String Name, boolean forceRead )
	{
		...
		CFSecSecGroupByUNameIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGroup().newUNameIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		if( ( ! forceRead ) && indexByUNameIdx.containsKey( key ) ) {
			...
			CFSecSecGroupBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().readDerivedByUNameIdx( schema.getAuthorization(),
				ClusterId,
				Name );
			if( buff != null ) {
				obj = schema.getSecGroupTableObj().newInstance();
	...
	public ICFSecSecGroupObj updateSecGroup( ICFSecSecGroupObj Obj ) {
		ICFSecSecGroupObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().updateSecGroup( schema.getAuthorization(),
			Obj.getSecGroupBuff() );
		obj = (ICFSecSecGroupObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteSecGroup( ICFSecSecGroupObj Obj ) {
		ICFSecSecGroupObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().deleteSecGroup( schema.getAuthorization(),
			obj.getSecGroupBuff() );
		Obj.forget();
	}
	...
	public void deleteSecGroupByClusterIdx( long ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().deleteSecGroupByClusterIdx( schema.getAuthorization(),
				ClusterId );
		...
		boolean IsVisible )
	{
		...
		if( indexByClusterVisIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().deleteSecGroupByClusterVisIdx( schema.getAuthorization(),
				ClusterId,
				IsVisible );
			Iterator<ICFSecSecGroupObj> iter = dict.values().iterator();
			ICFSecSecGroupObj obj;
		...
		String Name )
	{
		...
		if( indexByUNameIdx.containsKey( key ) ) {
			obj = indexByUNameIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableSecGroup().deleteSecGroupByUNameIdx( schema.getAuthorization(),
				ClusterId,
				Name );
			obj.forget();
		}
