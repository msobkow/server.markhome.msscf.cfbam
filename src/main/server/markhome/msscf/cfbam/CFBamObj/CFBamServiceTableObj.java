	...
	implements ICFBamServiceTableObj
{
	...
	public CFBamServiceTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecServiceObj newInstance() {
		ICFSecServiceObj inst = new CFBamServiceObj( schema );
		return( inst );
	}
	...
	public ICFSecServiceEditObj newEditInstance( ICFSecServiceObj orig ) {
		ICFSecServiceEditObj edit = new CFBamServiceEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				CFSecServiceByClusterIdxKey keyClusterIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryService().newClusterIdxKey();
			...
			if( indexByHostIdx != null ) {
				CFSecServiceByHostIdxKey keyHostIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryService().newHostIdxKey();
			...
			if( indexByTypeIdx != null ) {
				CFSecServiceByTypeIdxKey keyTypeIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryService().newTypeIdxKey();
			...
			if( indexByUTypeIdx != null ) {
				CFSecServiceByUTypeIdxKey keyUTypeIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryService().newUTypeIdxKey();
			...
			if( indexByUHostPortIdx != null ) {
				CFSecServiceByUHostPortIdxKey keyUHostPortIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryService().newUHostPortIdxKey();
	...
	public ICFSecServiceObj createService( ICFSecServiceObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableService().createService(
	...
	public ICFSecServiceObj readService( CFSecServicePKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecServiceBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableService().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredClusterId(),
				pkey.getRequiredServiceId() );
			if( readBuff != null ) {
				obj = schema.getServiceTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newPKey() );
	...
	{
		final String S_ProcName = "CFBamServiceTableObj.reallyDeepDisposeService() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecServiceByClusterIdxKey keyClusterIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecServiceByHostIdxKey keyHostIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newHostIdxKey();
		...
		CFSecServiceByTypeIdxKey keyTypeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newTypeIdxKey();
		keyTypeIdx.setRequiredServiceTypeId( existing.getRequiredServiceTypeId() );

		CFSecServiceByUTypeIdxKey keyUTypeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newUTypeIdxKey();
		...
		CFSecServiceByUHostPortIdxKey keyUHostPortIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newUHostPortIdxKey();
	...
	public ICFSecServiceObj lockService( CFSecServicePKey pkey ) {
		...
		CFSecServiceBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableService().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getServiceTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newPKey() );
	...
	public List<ICFSecServiceObj> readAllService( boolean forceRead ) {
		...
		if( ( allService == null ) || forceRead ) {
			...
			allService = map;
			CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().readAllDerived( schema.getAuthorization() );
		...
		Long priorServiceId )
	{
		...
		Map<CFSecServicePKey, ICFSecServiceObj> map = new HashMap<CFSecServicePKey,ICFSecServiceObj>();
		CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().pageAllBuff( schema.getAuthorization(),
			priorClusterId,
			priorServiceId );
		CFSecServiceBuff buff;
		ICFSecServiceObj obj;
	...
	{
		CFSecServicePKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecServiceByClusterIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newClusterIdxKey();
		...
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			...
			ICFSecServiceObj obj;
			CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().readDerivedByClusterIdx( schema.getAuthorization(),
				ClusterId );
			CFSecServiceBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		CFSecServiceByHostIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newHostIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		if( ( ! forceRead ) && indexByHostIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecServicePKey, ICFSecServiceObj>();
			ICFSecServiceObj obj;
			CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().readDerivedByHostIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId );
			CFSecServiceBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		boolean forceRead )
	{
		...
		CFSecServiceByTypeIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newTypeIdxKey();
		...
		if( ( ! forceRead ) && indexByTypeIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecServicePKey, ICFSecServiceObj>();
			ICFSecServiceObj obj;
			CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().readDerivedByTypeIdx( schema.getAuthorization(),
				ServiceTypeId );
			CFSecServiceBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		int ServiceTypeId, boolean forceRead )
	{
		...
		CFSecServiceByUTypeIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newUTypeIdxKey();
		key.setRequiredClusterId( ClusterId );
		key.setRequiredHostNodeId( HostNodeId );
		key.setRequiredServiceTypeId( ServiceTypeId );
		ICFSecServiceObj obj = null;
		if( ( ! forceRead ) && indexByUTypeIdx.containsKey( key ) ) {
			...
			CFSecServiceBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableService().readDerivedByUTypeIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId,
				ServiceTypeId );
			if( buff != null ) {
		...
		short HostPort, boolean forceRead )
	{
		...
		CFSecServiceByUHostPortIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryService().newUHostPortIdxKey();
		key.setRequiredClusterId( ClusterId );
		key.setRequiredHostNodeId( HostNodeId );
		...
		if( ( ! forceRead ) && indexByUHostPortIdx.containsKey( key ) ) {
			...
			CFSecServiceBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableService().readDerivedByUHostPortIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId,
				HostPort );
			if( buff != null ) {
		...
		Long priorServiceId )
	{
		...
		ICFSecServiceObj obj;
		CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().pageBuffByClusterIdx( schema.getAuthorization(),
				ClusterId,
			priorClusterId,
			priorServiceId );
		CFSecServiceBuff buff;
		...
		Long priorServiceId )
	{
		...
		List<ICFSecServiceObj> retList = new LinkedList<ICFSecServiceObj>();
		ICFSecServiceObj obj;
		CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().pageBuffByHostIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId,
			priorClusterId,
			priorServiceId );
		...
		Long priorServiceId )
	{
		...
		List<ICFSecServiceObj> retList = new LinkedList<ICFSecServiceObj>();
		ICFSecServiceObj obj;
		CFSecServiceBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableService().pageBuffByTypeIdx( schema.getAuthorization(),
				ServiceTypeId,
			priorClusterId,
			priorServiceId );
		CFSecServiceBuff buff;
	...
	public ICFSecServiceObj updateService( ICFSecServiceObj Obj ) {
		ICFSecServiceObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableService().updateService( schema.getAuthorization(),
			Obj.getServiceBuff() );
		obj = (ICFSecServiceObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteService( ICFSecServiceObj Obj ) {
		ICFSecServiceObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableService().deleteService( schema.getAuthorization(),
			obj.getServiceBuff() );
		Obj.forget();
	}
	...
	public void deleteServiceByClusterIdx( long ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableService().deleteServiceByClusterIdx( schema.getAuthorization(),
				ClusterId );
		...
		long HostNodeId )
	{
		...
		if( indexByHostIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableService().deleteServiceByHostIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId );
			Iterator<ICFSecServiceObj> iter = dict.values().iterator();
			ICFSecServiceObj obj;
	...
	public void deleteServiceByTypeIdx( int ServiceTypeId )
	{
		...
		if( indexByTypeIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableService().deleteServiceByTypeIdx( schema.getAuthorization(),
				ServiceTypeId );
			Iterator<ICFSecServiceObj> iter = dict.values().iterator();
			ICFSecServiceObj obj;
			List<ICFSecServiceObj> toForget = new LinkedList<ICFSecServiceObj>();
		...
		int ServiceTypeId )
	{
		...
		if( indexByUTypeIdx.containsKey( key ) ) {
			obj = indexByUTypeIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableService().deleteServiceByUTypeIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId,
				ServiceTypeId );
			obj.forget();
		...
		short HostPort )
	{
		...
		if( indexByUHostPortIdx.containsKey( key ) ) {
			obj = indexByUHostPortIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableService().deleteServiceByUHostPortIdx( schema.getAuthorization(),
				ClusterId,
				HostNodeId,
				HostPort );
			obj.forget();
