	...
	implements ICFBamFloatDefTableObj
{
	...
	public ICFBamFloatDefObj createFloatDef( ICFBamFloatDefObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().createFloatDef(
	...
	public ICFBamFloatDefObj readFloatDef( CFBamValuePKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFBamFloatDefBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().readDerivedByIdIdx( schema.getAuthorization(),
	...
	public ICFBamFloatDefObj readCachedFloatDef( CFBamValuePKey pkey ) {
		ICFBamFloatDefObj obj = null;
	...
	public void deepDisposeFloatDef( CFBamValuePKey pkey ) {
	...
	public ICFBamFloatDefObj lockFloatDef( CFBamValuePKey pkey ) {
		...
		CFBamFloatDefBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
	...
	public List<ICFBamFloatDefObj> readAllFloatDef( boolean forceRead ) {
		...
		if( ( allFloatDef == null ) || forceRead ) {
			...
			allFloatDef = map;
			CFBamFloatDefBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().readAllDerived( schema.getAuthorization() );
	...
	public ICFBamFloatDefObj readCachedFloatDefByIdIdx( long TenantId,
		long Id )
	{
		ICFBamFloatDefObj obj = null;
		CFBamValuePKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newPKey();
		pkey.setRequiredTenantId( TenantId );
		pkey.setRequiredId( Id );
		obj = readCachedFloatDef( pkey );
		return( obj );
	}

	public ICFBamFloatDefObj readCachedFloatDefByUNameIdx( long TenantId,
		long ScopeId,
		String Name )
	{
		ICFBamFloatDefObj obj = null;
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByValTentIdx( long TenantId )
	{
		final String S_ProcName = "readCachedFloatDefByValTentIdx";
		CFBamValueByValTentIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newValTentIdxKey();
		key.setRequiredTenantId( TenantId );
		ArrayList<ICFBamFloatDefObj> arrayList = new ArrayList<ICFBamFloatDefObj>();
		if( indexByValTentIdx != null ) {
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByScopeIdx( long TenantId,
		long ScopeId )
	{
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByDefSchemaIdx( Long DefSchemaTenantId,
		Long DefSchemaId )
	{
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByPrevIdx( Long PrevTenantId,
		Long PrevId )
	{
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByNextIdx( Long NextTenantId,
		Long NextId )
	{
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByContPrevIdx( long TenantId,
		long ScopeId,
		Long PrevId )
	{
	...
	public List<ICFBamFloatDefObj> readCachedFloatDefByContNextIdx( long TenantId,
		long ScopeId,
		Long NextId )
	{
	...
	public void deepDisposeFloatDefByIdIdx( long TenantId,
		long Id )
	{
		ICFBamFloatDefObj obj = readCachedFloatDefByIdIdx( TenantId,
				Id );
		if( obj != null ) {
			obj.forget();
		}
	...
	public void deepDisposeFloatDefByUNameIdx( long TenantId,
		long ScopeId,
		String Name )
	{
		ICFBamFloatDefObj obj = readCachedFloatDefByUNameIdx( TenantId,
				ScopeId,
				Name );
		if( obj != null ) {
			obj.forget();
	...
	public void deepDisposeFloatDefByValTentIdx( long TenantId )
	{
		final String S_ProcName = "deepDisposeFloatDefByValTentIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByValTentIdx( TenantId );
		if( arrayList != null )  {
	...
	public void deepDisposeFloatDefByScopeIdx( long TenantId,
		long ScopeId )
	{
		final String S_ProcName = "deepDisposeFloatDefByScopeIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByScopeIdx( TenantId,
				ScopeId );
		if( arrayList != null )  {
			Iterator<ICFBamFloatDefObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
	...
	public void deepDisposeFloatDefByDefSchemaIdx( Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		final String S_ProcName = "deepDisposeFloatDefByDefSchemaIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByDefSchemaIdx( DefSchemaTenantId,
				DefSchemaId );
		if( arrayList != null )  {
			Iterator<ICFBamFloatDefObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
	...
	public void deepDisposeFloatDefByPrevIdx( Long PrevTenantId,
		Long PrevId )
	{
		final String S_ProcName = "deepDisposeFloatDefByPrevIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByPrevIdx( PrevTenantId,
				PrevId );
		if( arrayList != null )  {
			Iterator<ICFBamFloatDefObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
	...
	public void deepDisposeFloatDefByNextIdx( Long NextTenantId,
		Long NextId )
	{
		final String S_ProcName = "deepDisposeFloatDefByNextIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByNextIdx( NextTenantId,
				NextId );
		if( arrayList != null )  {
			Iterator<ICFBamFloatDefObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
	...
	public void deepDisposeFloatDefByContPrevIdx( long TenantId,
		long ScopeId,
		Long PrevId )
	{
		final String S_ProcName = "deepDisposeFloatDefByContPrevIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByContPrevIdx( TenantId,
				ScopeId,
				PrevId );
		if( arrayList != null )  {
			Iterator<ICFBamFloatDefObj> arrayIter = arrayList.iterator();
	...
	public void deepDisposeFloatDefByContNextIdx( long TenantId,
		long ScopeId,
		Long NextId )
	{
		final String S_ProcName = "deepDisposeFloatDefByContNextIdx";
		ICFBamFloatDefObj obj;
		List<ICFBamFloatDefObj> arrayList = readCachedFloatDefByContNextIdx( TenantId,
				ScopeId,
				NextId );
		if( arrayList != null )  {
			Iterator<ICFBamFloatDefObj> arrayIter = arrayList.iterator();
	...
	public ICFBamFloatDefObj updateFloatDef( ICFBamFloatDefObj Obj ) {
		ICFBamFloatDefObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().updateFloatDef( schema.getAuthorization(),
			Obj.getFloatDefBuff() );
	...
	public void deleteFloatDef( ICFBamFloatDefObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDef( schema.getAuthorization(),
			obj.getFloatDefBuff() );
		Obj.forget();
		if( prev != null ) {
			prev.read( true );
		...
		long Id )
	{
		...
		pkey.setRequiredTenantId( TenantId );
		pkey.setRequiredId( Id );
		ICFBamFloatDefObj obj = readFloatDef( pkey );
		if( obj != null ) {
		...
		deepDisposeFloatDefByIdIdx( TenantId,
				Id );
	}
		...
		String Name )
	{
		...
		if( indexByUNameIdx.containsKey( key ) ) {
			obj = indexByUNameIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByUNameIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				Name );
			obj.forget();
		...
		deepDisposeFloatDefByUNameIdx( TenantId,
				ScopeId,
				Name );
	}
	...
	public void deleteFloatDefByValTentIdx( long TenantId )
	{
		...
		if( indexByValTentIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByValTentIdx( schema.getAuthorization(),
				TenantId );
		...
		deepDisposeFloatDefByValTentIdx( TenantId );
	}
		...
		long ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByScopeIdx( schema.getAuthorization(),
				TenantId,
				ScopeId );
			Iterator<ICFBamFloatDefObj> iter = dict.values().iterator();
			ICFBamFloatDefObj obj;
		...
		deepDisposeFloatDefByScopeIdx( TenantId,
				ScopeId );
	}
		...
		Long DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByDefSchemaIdx( schema.getAuthorization(),
				DefSchemaTenantId,
				DefSchemaId );
			Iterator<ICFBamFloatDefObj> iter = dict.values().iterator();
			ICFBamFloatDefObj obj;
		...
		deepDisposeFloatDefByDefSchemaIdx( DefSchemaTenantId,
				DefSchemaId );
	}
		...
		Long PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByPrevIdx( schema.getAuthorization(),
				PrevTenantId,
				PrevId );
			Iterator<ICFBamFloatDefObj> iter = dict.values().iterator();
			ICFBamFloatDefObj obj;
		...
		deepDisposeFloatDefByPrevIdx( PrevTenantId,
				PrevId );
	}
		...
		Long NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByNextIdx( schema.getAuthorization(),
				NextTenantId,
				NextId );
			Iterator<ICFBamFloatDefObj> iter = dict.values().iterator();
			ICFBamFloatDefObj obj;
		...
		deepDisposeFloatDefByNextIdx( NextTenantId,
				NextId );
	}
		...
		Long PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByContPrevIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				PrevId );
			Iterator<ICFBamFloatDefObj> iter = dict.values().iterator();
		...
		deepDisposeFloatDefByContPrevIdx( TenantId,
				ScopeId,
				PrevId );
	}
		...
		Long NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().deleteFloatDefByContNextIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				NextId );
			Iterator<ICFBamFloatDefObj> iter = dict.values().iterator();
		...
		deepDisposeFloatDefByContNextIdx( TenantId,
				ScopeId,
				NextId );
	}
	...
	public ICFBamFloatDefObj moveUpFloatDef( ICFBamFloatDefObj Obj ) {
		...
		CFBamFloatDefBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().moveBuffUp( schema.getAuthorization(),
	...
	public ICFBamFloatDefObj moveDownFloatDef( ICFBamFloatDefObj Obj ) {
		...
		CFBamFloatDefBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableFloatDef().moveBuffDown( schema.getAuthorization(),
			Obj.getRequiredTenantId(),
			Obj.getRequiredId(),
			Obj.getBuff().getRequiredRevision() );
		if( buff != null ) {
