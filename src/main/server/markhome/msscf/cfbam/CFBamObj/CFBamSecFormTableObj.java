	...
	implements ICFBamSecFormTableObj
{
	...
	public CFBamSecFormTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecSecFormObj newInstance() {
		ICFSecSecFormObj inst = new CFBamSecFormObj( schema );
		return( inst );
	}
	...
	public ICFSecSecFormEditObj newEditInstance( ICFSecSecFormObj orig ) {
		ICFSecSecFormEditObj edit = new CFBamSecFormEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				CFSecSecFormByClusterIdxKey keyClusterIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newClusterIdxKey();
			...
			if( indexBySecAppIdx != null ) {
				CFSecSecFormBySecAppIdxKey keySecAppIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newSecAppIdxKey();
			...
			if( indexByUJEEServletIdx != null ) {
				CFSecSecFormByUJEEServletIdxKey keyUJEEServletIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newUJEEServletIdxKey();
	...
	public ICFSecSecFormObj createSecForm( ICFSecSecFormObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableSecForm().createSecForm(
	...
	public ICFSecSecFormObj readSecForm( CFSecSecFormPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecSecFormBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredClusterId(),
				pkey.getRequiredSecFormId() );
			if( readBuff != null ) {
				obj = schema.getSecFormTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newPKey() );
	...
	{
		final String S_ProcName = "CFBamSecFormTableObj.reallyDeepDisposeSecForm() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecSecFormByClusterIdxKey keyClusterIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecSecFormBySecAppIdxKey keySecAppIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newSecAppIdxKey();
		...
		CFSecSecFormByUJEEServletIdxKey keyUJEEServletIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newUJEEServletIdxKey();
	...
	public ICFSecSecFormObj lockSecForm( CFSecSecFormPKey pkey ) {
		...
		CFSecSecFormBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getSecFormTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newPKey() );
	...
	public List<ICFSecSecFormObj> readAllSecForm( boolean forceRead ) {
		...
		if( ( allSecForm == null ) || forceRead ) {
			...
			allSecForm = map;
			CFSecSecFormBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().readAllDerived( schema.getAuthorization() );
		...
		Integer priorSecFormId )
	{
		...
		Map<CFSecSecFormPKey, ICFSecSecFormObj> map = new HashMap<CFSecSecFormPKey,ICFSecSecFormObj>();
		CFSecSecFormBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().pageAllBuff( schema.getAuthorization(),
			priorClusterId,
			priorSecFormId );
		CFSecSecFormBuff buff;
		ICFSecSecFormObj obj;
	...
	{
		CFSecSecFormPKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecSecFormByClusterIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newClusterIdxKey();
		...
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			...
			ICFSecSecFormObj obj;
			CFSecSecFormBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().readDerivedByClusterIdx( schema.getAuthorization(),
				ClusterId );
			CFSecSecFormBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		CFSecSecFormBySecAppIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newSecAppIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		if( ( ! forceRead ) && indexBySecAppIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecFormPKey, ICFSecSecFormObj>();
			ICFSecSecFormObj obj;
			CFSecSecFormBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().readDerivedBySecAppIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId );
			CFSecSecFormBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		String JEEServletMapName, boolean forceRead )
	{
		...
		CFSecSecFormByUJEEServletIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactorySecForm().newUJEEServletIdxKey();
		key.setRequiredClusterId( ClusterId );
		key.setRequiredSecAppId( SecAppId );
		...
		if( ( ! forceRead ) && indexByUJEEServletIdx.containsKey( key ) ) {
			...
			CFSecSecFormBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().readDerivedByUJEEServletIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId,
				JEEServletMapName );
			if( buff != null ) {
		...
		Integer priorSecFormId )
	{
		...
		ICFSecSecFormObj obj;
		CFSecSecFormBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().pageBuffByClusterIdx( schema.getAuthorization(),
				ClusterId,
			priorClusterId,
			priorSecFormId );
		CFSecSecFormBuff buff;
		...
		Integer priorSecFormId )
	{
		...
		List<ICFSecSecFormObj> retList = new LinkedList<ICFSecSecFormObj>();
		ICFSecSecFormObj obj;
		CFSecSecFormBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableSecForm().pageBuffBySecAppIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId,
			priorClusterId,
			priorSecFormId );
	...
	public ICFSecSecFormObj updateSecForm( ICFSecSecFormObj Obj ) {
		ICFSecSecFormObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableSecForm().updateSecForm( schema.getAuthorization(),
			Obj.getSecFormBuff() );
		obj = (ICFSecSecFormObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteSecForm( ICFSecSecFormObj Obj ) {
		ICFSecSecFormObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableSecForm().deleteSecForm( schema.getAuthorization(),
			obj.getSecFormBuff() );
		Obj.forget();
	}
	...
	public void deleteSecFormByClusterIdx( long ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableSecForm().deleteSecFormByClusterIdx( schema.getAuthorization(),
				ClusterId );
		...
		int SecAppId )
	{
		...
		if( indexBySecAppIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableSecForm().deleteSecFormBySecAppIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId );
			Iterator<ICFSecSecFormObj> iter = dict.values().iterator();
			ICFSecSecFormObj obj;
		...
		String JEEServletMapName )
	{
		...
		if( indexByUJEEServletIdx.containsKey( key ) ) {
			obj = indexByUJEEServletIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableSecForm().deleteSecFormByUJEEServletIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId,
				JEEServletMapName );
			obj.forget();
