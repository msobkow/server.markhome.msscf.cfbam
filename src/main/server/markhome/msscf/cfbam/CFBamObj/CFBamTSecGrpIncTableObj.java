...
public class CFBamTSecGrpIncTableObj
	implements ICFBamTSecGrpIncTableObj
{
	...
	public CFBamTSecGrpIncTableObj() {
		schema = null;
	...
	public CFBamTSecGrpIncTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecTSecGrpIncObj newInstance() {
		ICFSecTSecGrpIncObj inst = new CFBamTSecGrpIncObj( schema );
		return( inst );
	}
	...
	public ICFSecTSecGrpIncEditObj newEditInstance( ICFSecTSecGrpIncObj orig ) {
		ICFSecTSecGrpIncEditObj edit = new CFBamTSecGrpIncEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				CFSecTSecGrpIncByTenantIdxKey keyTenantIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newTenantIdxKey();
			...
			if( indexByGroupIdx != null ) {
				CFSecTSecGrpIncByGroupIdxKey keyGroupIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newGroupIdxKey();
			...
			if( indexByIncludeIdx != null ) {
				CFSecTSecGrpIncByIncludeIdxKey keyIncludeIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newIncludeIdxKey();
			...
			if( indexByUIncludeIdx != null ) {
				CFSecTSecGrpIncByUIncludeIdxKey keyUIncludeIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newUIncludeIdxKey();
	...
	public ICFSecTSecGrpIncObj createTSecGrpInc( ICFSecTSecGrpIncObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().createTSecGrpInc(
	...
	public ICFSecTSecGrpIncObj readTSecGrpInc( CFSecTSecGrpIncPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecTSecGrpIncBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredTenantId(),
				pkey.getRequiredTSecGrpIncId() );
			if( readBuff != null ) {
				obj = schema.getTSecGrpIncTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newPKey() );
	...
	{
		final String S_ProcName = "CFBamTSecGrpIncTableObj.reallyDeepDisposeTSecGrpInc() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecTSecGrpIncByTenantIdxKey keyTenantIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newTenantIdxKey();
		keyTenantIdx.setRequiredTenantId( existing.getRequiredTenantId() );

		CFSecTSecGrpIncByGroupIdxKey keyGroupIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newGroupIdxKey();
		...
		CFSecTSecGrpIncByIncludeIdxKey keyIncludeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newIncludeIdxKey();
		...
		CFSecTSecGrpIncByUIncludeIdxKey keyUIncludeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newUIncludeIdxKey();
	...
	public ICFSecTSecGrpIncObj lockTSecGrpInc( CFSecTSecGrpIncPKey pkey ) {
		...
		CFSecTSecGrpIncBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getTSecGrpIncTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newPKey() );
	...
	public List<ICFSecTSecGrpIncObj> readAllTSecGrpInc( boolean forceRead ) {
		...
		if( ( allTSecGrpInc == null ) || forceRead ) {
			...
			allTSecGrpInc = map;
			CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().readAllDerived( schema.getAuthorization() );
		...
		Long priorTSecGrpIncId )
	{
		...
		Map<CFSecTSecGrpIncPKey, ICFSecTSecGrpIncObj> map = new HashMap<CFSecTSecGrpIncPKey,ICFSecTSecGrpIncObj>();
		CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().pageAllBuff( schema.getAuthorization(),
			priorTenantId,
			priorTSecGrpIncId );
		CFSecTSecGrpIncBuff buff;
		ICFSecTSecGrpIncObj obj;
	...
	{
		CFSecTSecGrpIncPKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecTSecGrpIncByTenantIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newTenantIdxKey();
		...
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			...
			ICFSecTSecGrpIncObj obj;
			CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().readDerivedByTenantIdx( schema.getAuthorization(),
				TenantId );
			CFSecTSecGrpIncBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		CFSecTSecGrpIncByGroupIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newGroupIdxKey();
		key.setRequiredTenantId( TenantId );
		...
		if( ( ! forceRead ) && indexByGroupIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecTSecGrpIncPKey, ICFSecTSecGrpIncObj>();
			ICFSecTSecGrpIncObj obj;
			CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().readDerivedByGroupIdx( schema.getAuthorization(),
				TenantId,
				TSecGroupId );
			CFSecTSecGrpIncBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		boolean forceRead )
	{
		...
		CFSecTSecGrpIncByIncludeIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newIncludeIdxKey();
		key.setRequiredTenantId( TenantId );
		...
		if( ( ! forceRead ) && indexByIncludeIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecTSecGrpIncPKey, ICFSecTSecGrpIncObj>();
			ICFSecTSecGrpIncObj obj;
			CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().readDerivedByIncludeIdx( schema.getAuthorization(),
				TenantId,
				IncludeGroupId );
			CFSecTSecGrpIncBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		int IncludeGroupId, boolean forceRead )
	{
		...
		CFSecTSecGrpIncByUIncludeIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTSecGrpInc().newUIncludeIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredTSecGroupId( TSecGroupId );
		key.setRequiredIncludeGroupId( IncludeGroupId );
		ICFSecTSecGrpIncObj obj = null;
		if( ( ! forceRead ) && indexByUIncludeIdx.containsKey( key ) ) {
			...
			CFSecTSecGrpIncBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().readDerivedByUIncludeIdx( schema.getAuthorization(),
				TenantId,
				TSecGroupId,
				IncludeGroupId );
			if( buff != null ) {
		...
		Long priorTSecGrpIncId )
	{
		...
		ICFSecTSecGrpIncObj obj;
		CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().pageBuffByTenantIdx( schema.getAuthorization(),
				TenantId,
			priorTenantId,
			priorTSecGrpIncId );
		CFSecTSecGrpIncBuff buff;
		...
		Long priorTSecGrpIncId )
	{
		...
		List<ICFSecTSecGrpIncObj> retList = new LinkedList<ICFSecTSecGrpIncObj>();
		ICFSecTSecGrpIncObj obj;
		CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().pageBuffByGroupIdx( schema.getAuthorization(),
				TenantId,
				TSecGroupId,
			priorTenantId,
			priorTSecGrpIncId );
		...
		Long priorTSecGrpIncId )
	{
		...
		List<ICFSecTSecGrpIncObj> retList = new LinkedList<ICFSecTSecGrpIncObj>();
		ICFSecTSecGrpIncObj obj;
		CFSecTSecGrpIncBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().pageBuffByIncludeIdx( schema.getAuthorization(),
				TenantId,
				IncludeGroupId,
			priorTenantId,
			priorTSecGrpIncId );
	...
	public ICFSecTSecGrpIncObj updateTSecGrpInc( ICFSecTSecGrpIncObj Obj ) {
		ICFSecTSecGrpIncObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().updateTSecGrpInc( schema.getAuthorization(),
	...
	public void deleteTSecGrpInc( ICFSecTSecGrpIncObj Obj ) {
		ICFSecTSecGrpIncObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().deleteTSecGrpInc( schema.getAuthorization(),
			obj.getTSecGrpIncBuff() );
		Obj.forget();
	}
	...
	public void deleteTSecGrpIncByTenantIdx( long TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().deleteTSecGrpIncByTenantIdx( schema.getAuthorization(),
				TenantId );
		...
		int TSecGroupId )
	{
		...
		if( indexByGroupIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().deleteTSecGrpIncByGroupIdx( schema.getAuthorization(),
				TenantId,
				TSecGroupId );
			Iterator<ICFSecTSecGrpIncObj> iter = dict.values().iterator();
			ICFSecTSecGrpIncObj obj;
		...
		int IncludeGroupId )
	{
		...
		if( indexByIncludeIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().deleteTSecGrpIncByIncludeIdx( schema.getAuthorization(),
				TenantId,
				IncludeGroupId );
			Iterator<ICFSecTSecGrpIncObj> iter = dict.values().iterator();
			ICFSecTSecGrpIncObj obj;
		...
		int IncludeGroupId )
	{
		...
		if( indexByUIncludeIdx.containsKey( key ) ) {
			obj = indexByUIncludeIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableTSecGrpInc().deleteTSecGrpIncByUIncludeIdx( schema.getAuthorization(),
				TenantId,
				TSecGroupId,
				IncludeGroupId );
			obj.forget();
