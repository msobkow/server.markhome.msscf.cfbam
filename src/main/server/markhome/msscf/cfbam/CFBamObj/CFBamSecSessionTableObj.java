	...
	implements ICFBamSecSessionTableObj
{
	...
	{
		final String S_ProcName = "CFBamSecSessionTableObj.reallyDeepDisposeSecSession() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecSecSessionBySecUserIdxKey keySecUserIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecSession().newSecUserIdxKey();
		keySecUserIdx.setRequiredSecUserId( existing.getRequiredSecUserId() );

		CFSecSecSessionBySecDevIdxKey keySecDevIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecSession().newSecDevIdxKey();
		...
		CFSecSecSessionByStartIdxKey keyStartIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecSession().newStartIdxKey();
		keyStartIdx.setRequiredSecUserId( existing.getRequiredSecUserId() );
		keyStartIdx.setRequiredStart( existing.getRequiredStart() );

		CFSecSecSessionByFinishIdxKey keyFinishIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecSession().newFinishIdxKey();
		keyFinishIdx.setRequiredSecUserId( existing.getRequiredSecUserId() );
		keyFinishIdx.setOptionalFinish( existing.getOptionalFinish() );

		CFSecSecSessionBySecProxyIdxKey keySecProxyIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecSession().newSecProxyIdxKey();
