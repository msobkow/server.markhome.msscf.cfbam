...
public class CFBamISOTZoneTableObj
	implements ICFBamISOTZoneTableObj
{
	...
	public CFBamISOTZoneTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecISOTZoneObj newInstance() {
		ICFSecISOTZoneObj inst = new CFBamISOTZoneObj( schema );
		return( inst );
	}
	...
	public ICFSecISOTZoneEditObj newEditInstance( ICFSecISOTZoneObj orig ) {
		ICFSecISOTZoneEditObj edit = new CFBamISOTZoneEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByOffsetIdx != null ) {
				CFSecISOTZoneByOffsetIdxKey keyOffsetIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newOffsetIdxKey();
			...
			if( indexByUTZNameIdx != null ) {
				CFSecISOTZoneByUTZNameIdxKey keyUTZNameIdx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newUTZNameIdxKey();
			...
			if( indexByIso8601Idx != null ) {
				CFSecISOTZoneByIso8601IdxKey keyIso8601Idx =
					((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newIso8601IdxKey();
	...
	public ICFSecISOTZoneObj createISOTZone( ICFSecISOTZoneObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().createISOTZone(
	...
	public ICFSecISOTZoneObj readISOTZone( CFSecISOTZonePKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecISOTZoneBuff readBuff = ((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredISOTZoneId() );
			if( readBuff != null ) {
				obj = schema.getISOTZoneTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newPKey() );
	...
	{
		final String S_ProcName = "CFBamISOTZoneTableObj.reallyDeepDisposeISOTZone() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecISOTZoneByOffsetIdxKey keyOffsetIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newOffsetIdxKey();
		...
		CFSecISOTZoneByUTZNameIdxKey keyUTZNameIdx = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newUTZNameIdxKey();
		keyUTZNameIdx.setRequiredTZName( existing.getRequiredTZName() );

		CFSecISOTZoneByIso8601IdxKey keyIso8601Idx = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newIso8601IdxKey();
	...
	public ICFSecISOTZoneObj lockISOTZone( CFSecISOTZonePKey pkey ) {
		...
		CFSecISOTZoneBuff lockBuff = ((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getISOTZoneTableObj().newInstance();
			locked.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newPKey() );
	...
	public List<ICFSecISOTZoneObj> readAllISOTZone( boolean forceRead ) {
		...
		if( ( allISOTZone == null ) || forceRead ) {
			...
			allISOTZone = map;
			CFSecISOTZoneBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().readAllDerived( schema.getAuthorization() );
	...
	{
		CFSecISOTZonePKey pkey = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newPKey();
		...
		boolean forceRead )
	{
		...
		CFSecISOTZoneByOffsetIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newOffsetIdxKey();
		...
		if( ( ! forceRead ) && indexByOffsetIdx.containsKey( key ) ) {
			...
			ICFSecISOTZoneObj obj;
			CFSecISOTZoneBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().readDerivedByOffsetIdx( schema.getAuthorization(),
				TZHourOffset,
				TZMinOffset );
			CFSecISOTZoneBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public ICFSecISOTZoneObj readISOTZoneByUTZNameIdx( String TZName, boolean forceRead )
	{
		...
		CFSecISOTZoneByUTZNameIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newUTZNameIdxKey();
		...
		if( ( ! forceRead ) && indexByUTZNameIdx.containsKey( key ) ) {
			...
			CFSecISOTZoneBuff buff = ((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().readDerivedByUTZNameIdx( schema.getAuthorization(),
				TZName );
			if( buff != null ) {
				obj = schema.getISOTZoneTableObj().newInstance();
				obj.setPKey( ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newPKey() );
		...
		boolean forceRead )
	{
		...
		CFSecISOTZoneByIso8601IdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryISOTZone().newIso8601IdxKey();
		...
		if( ( ! forceRead ) && indexByIso8601Idx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecISOTZonePKey, ICFSecISOTZoneObj>();
			ICFSecISOTZoneObj obj;
			CFSecISOTZoneBuff[] buffList = ((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().readDerivedByIso8601Idx( schema.getAuthorization(),
				Iso8601 );
			CFSecISOTZoneBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
	...
	public ICFSecISOTZoneObj updateISOTZone( ICFSecISOTZoneObj Obj ) {
		ICFSecISOTZoneObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().updateISOTZone( schema.getAuthorization(),
			Obj.getISOTZoneBuff() );
		obj = (ICFSecISOTZoneObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteISOTZone( ICFSecISOTZoneObj Obj ) {
		ICFSecISOTZoneObj obj = Obj;
		((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().deleteISOTZone( schema.getAuthorization(),
			obj.getISOTZoneBuff() );
		Obj.forget();
	}
		...
		short TZMinOffset )
	{
		...
		if( indexByOffsetIdx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().deleteISOTZoneByOffsetIdx( schema.getAuthorization(),
				TZHourOffset,
				TZMinOffset );
	...
	public void deleteISOTZoneByUTZNameIdx( String TZName )
	{
		...
		if( indexByUTZNameIdx.containsKey( key ) ) {
			obj = indexByUTZNameIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().deleteISOTZoneByUTZNameIdx( schema.getAuthorization(),
				TZName );
			obj.forget();
		}
		else {
	...
	public void deleteISOTZoneByIso8601Idx( String Iso8601 )
	{
		...
		if( indexByIso8601Idx.containsKey( key ) ) {
			...
			((ICFBamSchema)schema.getBackingStore()).getTableISOTZone().deleteISOTZoneByIso8601Idx( schema.getAuthorization(),
				Iso8601 );
			Iterator<ICFSecISOTZoneObj> iter = dict.values().iterator();
			ICFSecISOTZoneObj obj;
			List<ICFSecISOTZoneObj> toForget = new LinkedList<ICFSecISOTZoneObj>();
