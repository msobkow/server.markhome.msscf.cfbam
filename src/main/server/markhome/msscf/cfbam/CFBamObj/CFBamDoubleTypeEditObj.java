// Description: Java 11 edit object instance implementation for CFBam DoubleType.
	...
	implements ICFBamDoubleTypeEditObj
{
	...
	public ICFBamValueObj realise() {
		...
		ICFBamDoubleTypeObj retobj = getSchema().getDoubleTypeTableObj().realiseDoubleType( (ICFBamDoubleTypeObj)this );
		return( retobj );
	}

	public void forget() {
		getOrigAsDoubleType().forget();
	}
	...
	public ICFBamValueObj create() {
		copyBuffToOrig();
		ICFBamDoubleTypeObj retobj = ((ICFBamSchemaObj)getOrigAsDoubleType().getSchema()).getDoubleTypeTableObj().createDoubleType( getOrigAsDoubleType() );
	...
	public CFBamValueBuff getBuff() {
		if( buff == null ) {
			buff = ((ICFBamSchema)getOrigAsDoubleType().getSchema().getBackingStore()).getFactoryDoubleType().newBuff();
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsDoubleType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getPKey().getRequiredTenantId(),
