	...
	implements ICFBamSecGrpIncTableObj
{
	...
	{
		final String S_ProcName = "CFBamSecGrpIncTableObj.reallyDeepDisposeSecGrpInc() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecSecGrpIncByClusterIdxKey keyClusterIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGrpInc().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecSecGrpIncByGroupIdxKey keyGroupIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGrpInc().newGroupIdxKey();
		...
		CFSecSecGrpIncByIncludeIdxKey keyIncludeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGrpInc().newIncludeIdxKey();
		...
		CFSecSecGrpIncByUIncludeIdxKey keyUIncludeIdx = ((ICFBamSchema)schema.getBackingStore()).getFactorySecGrpInc().newUIncludeIdxKey();
